...
export default function BentoGridCard({ item, animate, passRef, exceptionItem, disabled, highlightClick, revertClick, showContent }) {
  ...
  const itemLookup = {
    "javascript": { "name": "JavaScript", icon: <JavaScriptLogo />, classes: "highlightLeft highlightTop", stats: ["1+", "30+", "2"] },
    "html_css": { "name": "HTML/CSS", icon: <HTMLLogo />, classes: "highlightCenter highlightTop", stats: ["2+", "15+", "0"] },
    ...
    "nextjs": { "name": "NextJS", icon: <NextJSLogo />, classes: "highlightCenter highlightBottom", stats: ["<1", "3", "2"] },
