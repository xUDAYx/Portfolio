...
export async function getServerSideProps(context) {
  ...
  return {
    props: {
      domain,
      name: domain === "letstinkercode.dev" ? "UDAY" : "UDAY",
    }
  }
}
...
export default function Home({ domain, name }) {
  ...
  return (
    <>
      <SeoHandler 
        title={domain === "letstinkercode.dev" ? "letstinkercode.dev" : "letstinkercode.dev"}
        description={domain === "letstinkercode.dev" ? `Hello world. I'm Uday, a ${getCurrentAge()} year old developer from India.` : `Hello world. I'm Uday, a ${getCurrentAge()} developer from India.`}
        url={domain === "letstinkercode.dev" ? "letstinkercode.dev" : "letstinkercode.dev"}
        image={'/icon.png'}
      />
      <main className={`min-h-screen px-4 md:px-20 2xl:px-72 z-10 flex flex-col ${anonymousPro.className}`}>
        <section className="flex flex-row items-center w-full h-[80vh] sm:mb-[10vh] justify-between">
          <div className="z-10 w-fit">
            ...
            <p className="text-2xl">I'm a {getCurrentAge()} year old developer from India.</p>
            <div className="flex flex-row items-center mt-4">
              <Button type="main" href="https://github.com/xUDAYx" target="_blank">My work</Button>
              <Button type="sub" href="#contact" target="_blank">Contact</Button>
              <Button type="sub" href="https://drive.google.com/file/d/1vD3EvWtIwgzElWIcbGB3hOee4NyOB00n/view" target="_blank">Resume</Button>
            </div>
          </div>
          <BackgroundAnim />
        </section>
        <section className="w-full h-auto md:h-[70vh] mb-[5vh] sm:mb-[20vh]" id="bento-grid">
          ...
          <div id="bento-grid-left">
            <div id="flex-1" className={`w-full ${expandCarousel == true ? "h-full" : "h-2/5"}`}>
              <div id="carousel-container" className={`h-[full] md:h-full bento-card-container ${expandCarousel == true ? "w-full" : "w-1/2"}`} ref={carouselRef}>
              ...
              <div className={`w-full md:w-1/2 md:h-full bento-card-container  ${hideGridAndTools == true && "hidden"}`} ref={toolIconsRef}>
            ...
            <div id="info-container-top" className="flex flex-row h-24 lg:h-1/5 items-center mb-4" ref={generalInfoRef}>
              <div className={`bento-card anim-top mr-4 ${showYearsOfExperience && "animate"}`}>
                <div className="flex flex-col">
                  <h1 className="m-0 text-5xl font-bold" style={{ color: "var(--color-main)" }}>1+</h1>
              ...
              <div className={`bento-card anim-right ${showJobStatus && "animate"}`}>
                <div className="flex flex-col">
                  <div className="h-[48px] flex w-full items-center">
                    <div className="h-8 w-8 bg-green-400 rounded-full" />
                  </div>
                  <p>avilable</p>
                </div>
              </div>
          ...
          <div className="w-full h-auto md:h-[calc(100%-45px)] flex flex-col md:flex-row items-center">
            <div className="h-fit mb-4 md:h-full md:w-[calc(50%-1.5rem)] md:mr-4 relative" id="contact-form-info">
              ...
              <div className="flex !ml-4 md:justify-center flex-row items-center md:mt-8 md:absolute bottom-0">
                <a href="https://www.linkedin.com/in/uday-jawheri/" className="diamond-container">
                  <div>
                    <Twitter className={"h-6 w-6 mx-auto"} />
                  </div>
                </a>
                {domain === "letstinkercode.dev" && (
                  <a href="https://www.linkedin.com/in/uday-jawheri/" className="diamond-container">
                    <div>
                ...
                <a href="mailto:jobkmail.udayjawheri@gmail.com" className="diamond-container">
                  <div>
        ...
        <span className="text-center text-base mb-4"> Team D-Sync, 2024 - Current</span>
      </main>
    </>
  )
}